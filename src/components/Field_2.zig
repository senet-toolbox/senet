...
pub fn creditCardCallback(credit_card_buf: *[]const u8, evt: *Vapor.Event) void {
    const text = evt.text();
...
fn telephoneCallback(telephone_buf: *[]const u8, evt: *Vapor.Event) void {
    const text = evt.text();
    if (text.len == 0) return;
            ...
            switch (field.type) {
                ...
                .telephone => {
                    ...
                    text_field
                        ...
                        .border(.none)
                        .width(.percent(100))
                        .onEventCtx(.input, telephoneCallback, value.telephone)
                        .val(value.telephone)
                        .end();
                },
                .credit_card => {
                    ...
                    text_field
                        ...
                        .border(.none)
                        .width(.percent(100))
                        .onEventCtx(.input, creditCardCallback, value.credit_card)
