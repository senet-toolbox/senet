...
// Mardkown file
const vaporize_page = @embedFile("vaporize_page.md");
...
pub fn init() void {
    ...
    markdown.compile(vaporize_page) catch |err| {
...
The above example compiles and renders this exact documentation page you are reading right now!
Feel free to copy the markdown file, and try the code out yourself.
...
**We are not fetching the markdown files, feel free to inspect the page network tab.**
